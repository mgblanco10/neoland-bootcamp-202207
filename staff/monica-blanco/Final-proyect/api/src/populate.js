...
let pepito, wendy, peter, james

connect('mongodb://127.0.0.1:27017/workspaces')
    .then(() => {
        debugger
        console.log( `db connected`)
        return Promise.all([User.deleteMany(), Building.deleteMany(), Reservation.deleteMany(),Workspace.deleteMany()]) 
    })
    .then(() => {
        pepito = new User({
            name: 'Pepito Grillo',
    ...
    .then(()=>{
        ...
        const pobleNou = new Building({
            ...
            image: 'https://st.hzcdn.com/simgs/pictures/despachos/neoland-oficinas-meepstudio-img~951131e60ea96431_4-9543-1-639b8cf.jpg'
        })
        const diagonal = new Building({
            name:'diagonal building',
            address:'Diagonal 444 Catalonia Barcelona, B 08037',
            image: ' https://www.neoland.es/wp-content/uploads/2021/11/neoland-remoto-bootcamps-1.jpg'
        })
        return Promise.all([
            pobleNou.save(),
            diagonal.save()])
    ...
    .then(([pobleNou, diagonal])=>{
        const office1 = new Workspace({
            ...
            price: 100,
            image:'https://pcasistencia.com/wp-content/uploads/2018/07/513c1c6b5e6d006625511982fdb30d2c.jpg',
        ...
        const office4 = new Workspace({
            ...
            name: 'living room',
            price: 100,
            image:'https://www.profesionalreview.com/wp-content/uploads/2020/06/Ordenador-en-el-suelo-o-en-la-mesa-03-scaled.jpg',
        ...
        const office5 = new Workspace({
            ...
            name: 'desk',
            price: 100,
            image:'https://habitarehome.es/185-large_default/mesa-de-escritorio-en-angulo-roma.jpg',
            description:'Enjoy shared services and meeting rooms.'
        })
        return Promise.all([
            office1.save(),
    ...
    .then(([office1, office2, office3, office4, office5]) => {
        debugger
