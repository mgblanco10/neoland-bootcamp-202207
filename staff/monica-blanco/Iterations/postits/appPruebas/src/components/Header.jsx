...
function Header({name, onLogoutClick, onSettingsClick, onHomeClick, view:viewHome}){
    ...
    <img className="imgHeader" src="https://media4.giphy.com/media/lnyLJ57x8jJ13ZDhTZ/giphy.gif?cid=a267dfa35mpqsy8edagjq1n6d14c20r903cyt2gneqzbgona&rid=giphy.gif&60490a1f0d4f710d77dfff46&1653264000136"/>
        <h1 className="title"> Hello, {name}! </h1>
            ...
            { view === 'menu' && <Menu onLogoutClick={onLogoutClick} onSettingsClick={handleSettingsClick} onHomeClick={handleHomeClick} view={viewHome} />}
        </header>)
