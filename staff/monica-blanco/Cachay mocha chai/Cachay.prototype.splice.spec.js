describe('Cachay prototype splice', () => {
    ...
    it('replace elements', () => {
        const months = new Cachay ('Jan', 'Feb', 'Mar', 'Apr', 'Jun', 'Jun', 'Jun', 'Jul')
    ...
    it('remove element at index', () => {
        ...
        expect(removed[0]).to.equal ('mandarin')
    ...
    it('remove element from negative index', () => {
        ...
        expect(removed[0]).to.equal ('drum')
        expect(removed[1]).to.equal ('mandarin')
