...
<>
    <div className="py-10 8px pr-5 p-6 md:break-inside-avoid-column max-w-sm mx-auto rounded overflow-hidden justify-items-center float-left">
      ...
      <div className="px-6 pt-4 pb-2">
        <a className="text-gray-700 text-xl hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium cursor-pointer" onClick={() => {onClick(location.id)}} >See Office</a>
      </div>
    </div>
  </>
  ));
